<?php
/*!
 * remoteConnectoin.php
 * https://github.com/raulBiescas/coreLibraries
 * Version: 1.0.0
 *
 * Copyright 2021 remoteConnection.php Contributors
 ...
 */
 ...
 /** 
    ...
    class HttpConnection {  
		...
		public function postString($url,$postText,$referer='') {  
            $this->init();   
            curl_setopt($this->curl, CURLOPT_URL, $url);  
            curl_setopt($this->curl, CURLOPT_POST,true);  
			curl_setopt($this->curl, CURLOPT_REFERER, $referer); 			
            curl_setopt($this->curl, CURLOPT_POSTFIELDS, $postText);  
            $result=curl_exec ($this->curl);  
            $this->_close();  
            return $result;  
        }
